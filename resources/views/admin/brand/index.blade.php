                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                                ...
                                <div class="layui-input-inline layui-show-xs-block">
                                    ...
                                    <button class="layui-btn"  onclick="xadmin.open('添加','{{'/admin/brand/create?cate_id='.$cate['cate_id']}}')"   ><i class="layui-icon"></i>添加</button>
                                </div>
...
@foreach ($brand_list as $v)
                                ...
                                <tr  >
                                  ...
                                  <td class="td-manage">
                                    <button class="layui-btn layui-btn layui-btn-xs"  onclick="xadmin.open('编辑','{{'/admin/brand/'.$v['brand_id'].'/edit'}}')" ><i class="layui-icon">&#xe642;</i>编辑</button>
                                    <button class="layui-btn-danger layui-btn layui-btn-xs"  onclick="member_del(this,'{{ $v['brand_id']}}')" href="javascript:;" ><i class="layui-icon">&#xe640;</i>删除</button>
                                  </td>
                                </tr>
