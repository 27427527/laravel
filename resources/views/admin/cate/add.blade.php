               ...
               <div class="layui-form-item">
                ...
                <table width="100%"  cellspacing="0" cellpadding="0" class="layui-table">
                    ...
                    <td>
                            	...
                            	<button  type="button" class="layui-btn lay_up" data-id="{{ $parent_id }}">
		  <i class="layui-icon">&#xe67c;</i>上传图片
		</button>
    
         <input type="hidden" name="image" id="{{ $parent_id }}_input"  >


			<a id="{{ $parent_id }}_a" href=" target="_blank">
        
        <img id="{{ $parent_id }}_pic" src="/images/point.png"  height="38"/>
      </a>
			
			<a data-id="{{ $parent_id }}" href="javascript:;" onclick="if(confirm('确定删除吗!')){delete_img({{ $parent_id }})}" class="delete">删除</a>
