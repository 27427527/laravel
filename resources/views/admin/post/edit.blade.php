    ...
    <div class="layui-fluid">
        <div class="layui-row">
            <form action="" id="role_form" method="post" class="layui-form layui-form-pane" >
               ...
               <input type="hidden" name="cate_id" value="{{ $post->cate_id }}"  >
               <div class="layui-form-item">
                ...
                <table width="100%"  cellspacing="0" cellpadding="0" class="layui-table">
                    ...
                    <td>
                    <button  type="button" class="layui-btn lay_up" data-id="{{ $post->post_id }}">
		                <i class="layui-icon">&#xe67c;</i>上传
		                  </button>

    <blockquote class="layui-elem-quote layui-quote-nm" style="margin-top: 11px;">
    <div class="layui-upload-list" id="{{ $post->post_id }}_upload-dan-preview">
      <li class="pre-li" data-image="{{ $post->image }}" ><input type="hidden" name="image" value="{{ $post->image }}" ><i class="icon iconfont">&#xe6b7;</i><img class="pre-img" src="/storage/{{ $post->image }}"  ></li>
    </div>
 </blockquote>
                    ...
                    <td> 内容</td>
                    <td>
                     <textarea class="editor" id="container" name="content"  rows="5">{{ $post->content }}</textarea>
                    </td>
                    </tr> 
